import {
  ...
  Target, Award, FileText, MessageSquare, LogOut
} from "lucide-react";
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">Track your work, tasks, and performance</p>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-1">93% productive</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-1">2 due today</p>
                  </div>
          ...
          {/* Leave Balance and Quick Actions */}
          <div className="grid gap-6 lg:grid-cols-2">
            {/* Leave Balance */}
            <Card>
              <CardHeader>
